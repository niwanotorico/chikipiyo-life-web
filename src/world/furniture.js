...
export const furnitureDefinitions=[
 {id:'bed',name:'ベッド',icon:'☾',action:'sleep',label:'寝る',position:[-3.7,0,-2.4],spot:[-3.5,0,-.95],face:Math.PI,footprint:[2.3,2.5]},
 {id:'sofa',name:'ソファ',icon:'▱',action:'relax',label:'くつろぐ',position:[-3.5,0,1.5],spot:[-2.9,0,2.55],face:Math.PI,footprint:[2.7,1.35]},
 {id:'table',name:'テーブル',icon:'◷',action:'eat',label:'食べる',position:[.2,0,.65],spot:[.2,0,1.9],face:Math.PI,footprint:[1.9,1.4]},
 {id:'kitchen',name:'キッチン',icon:'♨',action:'cook',label:'料理する',position:[3,0,-3.2],spot:[2.65,0,-2],face:Math.PI,footprint:[2.8,1.25]},
 {id:'fridge',name:'冷蔵庫',icon:'▥',action:'snack',label:'おやつを探す',position:[4.65,0,-3.1],spot:[4.45,0,-1.9],face:Math.PI,footprint:[1,1.25]},
 {id:'vr',name:'VRヘッドセット',icon:'∞',action:'vr',label:'VRで遊ぶ',position:[3.7,0,2.7],spot:[3,0,1.65],face:0,footprint:[.9,.8]},
 {id:'desk',name:'小さな作業机',icon:'▤',action:'read',label:'読書する',position:[.1,0,-3.2],spot:[.1,0,-2.05],face:Math.PI,footprint:[1.8,1.2]},
];
export function createFurniture(scene){return furnitureDefinitions.map(d=>{const g=new T.Group();g.position.set(...d.position);g.userData.furnitureId=d.id;scene.add(g);const wood=0xb99570,white=0xf7f3e8,mint=0x8ab6a2;
 ...
 if(d.id==='vr'){cylinder(g,.43,.52,[0,.28,0],wood);box(g,[.58,.24,.3],[0,.67,0],0x444e59,.09);box(g,[.45,.13,.035],[0,.68,.16],0xa7d8cd,.05);}
